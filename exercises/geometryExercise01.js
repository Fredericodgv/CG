...
function generatePoints()
{
  var points = [
    ...
    new THREE.Vector3(2.0, 2.0, 0.0), // p0
    new THREE.Vector3(4.0, 0.0, 0.0), // p1
    new THREE.Vector3(0.0, 0.0, 0.0), // p2
    new THREE.Vector3(0.0, 2.0, 0.0), // p3
    new THREE.Vector3(2.0, 2.0, 2.0), // p4
    new THREE.Vector3(4.0, 0.0, 2.0), // p5
    new THREE.Vector3(0.0, 0.0, 2.0), // p6
    new THREE.Vector3(0.0, 2.0, 2.0) // p7 
  ];
